  ...
  return (
    <article className="bg-white cursor-pointer w-56 h-60 hover:scale-105 transition-all">
      <figure className="relative mb-2 w-full h-4/5">
        ...
        <button className="absolute top-2 right-2 flex justify-center items-center rounded-full bg-white w-6 h-6 shadow-lg hover:bg-slate-900/40 hover:fill-white hover:-translate-y-1 transition-all" onClick={increaseCartCounter}>
